 ...
 */
 ...
 $numero = $data["maior"] + 1;
     ...
     Alterações feitas em 11/01/2016 - 10h45<BR>
     - Nova numeração para os ofícios de 2016
     <P>
     </font></small>
     Anos anteriores:
     <b><a target='_blank' href='doc_oficio_generico.php?ano=2009&ordem=Order by ofi_numero DESC'>2009</a></b> |
     <b><a target='_blank' href='doc_oficio_generico.php?ano=2010&ordem=Order by ofi_numero DESC'>2010</a></b> |
     <b><a target='_blank' href='doc_oficio_generico.php?ano=2011&ordem=Order by ofi_numero DESC'>2011</a></b> |
     <b><a target='_blank' href='doc_oficio_generico.php?ano=2012&ordem=Order by ofi_numero DESC'>2012</a></b> |
     <b><a target='_blank' href='doc_oficio_generico.php?ano=2013&ordem=Order by ofi_numero DESC'>2013</a></b> |
     <b><a target='_blank' href='doc_oficio_generico.php?ano=2014&ordem=Order by ofi_numero DESC'>2014</a></b> |
     <b><a target='_blank' href='doc_oficio_generico.php?ano=2015&ordem=Order by ofi_numero DESC'>2015</a></b> <br><br>
     <table border=1>
       <tr>
       ...
       <form action=incluir.php?indice=1 method=post>
       <tr>
         <td>
           <!--
           <input type=text name=ofi_numero size=4 value='$numero'>/<input type=text name=ofi_ano value=2016 size=4>
           -->
           ##/2016
         </td>
         <td>
           <input type=text name=ofi_data size=10 id=ofi_data value='$hoje'>
           <button type=reset id=trigger>...</button>
           <script type=\"text/javascript\">
             Calendar.setup(
             {

               inputField : 'ofi_data', // ID of the input field
         ...
         <td>
           <input type=text name=ofi_destino size=32>
         </td>
         <td>
           <input type=text name=ofi_assunto size=64>
         </td>
         <td>
           $usuario
     ...
     $sql = "Select * From doc_oficio " . $ordem;
     $res = abre_query($db,$sql) or die(mysql_error());
